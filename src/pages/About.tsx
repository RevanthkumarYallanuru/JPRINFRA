    ...
    <div>
      ...
      <section className="relative py-32 bg-gradient-to-br from-primary to-primary/80 text-primary-foreground overflow-hidden">
        <div className="absolute inset-0 opacity-20">
          <img src={heroImage} alt="About JPR INFRAWORKERS" className="w-full h-full object-cover" loading="lazy" />
        </div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center animate-fade-in">
            ...
            <p className="text-xl text-primary-foreground/90 leading-relaxed">
              Building Excellence Since Years - Your Trusted Construction Partner
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg max-w-none text-muted-foreground">
              <p className="mb-4 leading-relaxed">
                JPR INFRAWORKERS is a leading construction and infrastructure development company dedicated to delivering exceptional quality and innovative solutions. With years of experience in the industry, we have established ourselves as a trusted name in residential, commercial, and infrastructure projects.
              </p>
              <p className="mb-4 leading-relaxed">
